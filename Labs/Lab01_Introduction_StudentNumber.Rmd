...
knitr::include_graphics('data/knit.png')
```
...
You can keep notes about the R part of the lab here and execute code like in the code block below:
...
```
The solution is not 1 because of the order of operations: BEDMAS. When operations are tied, R executes commands left to right.
...
```
The function log() takes two arguments: x and base.
...
```
The function rep() replicates the values of x, n times.
...
#### Figure out what is wrong with the following R commands and try to think if you can fix them:
...
When you have completed all exercises and are happy with your progress today, please knit your document and submit it to Canvas. If you finish before the time is up, start with the required readings of Week 2 or help out your fellow students. 
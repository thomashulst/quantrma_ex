...
4. What is the probability to obtain **at least** 4 heads (so 4, 5, 6, 7, 8, 9, or 10 heads). You can calculate this probability in two ways, either by using `pbinom()` with an additional argument, or by using your answers from question 3. 

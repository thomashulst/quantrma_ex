...
#### Load the data
We load the data into a data frame. Reminder, the following assumes that you have downloaded the zip file with the [labs template] (https://github.com/thomashulst/quantrma_lab/raw/master/Labs_Template.zip) which contains the data file in the data folder.

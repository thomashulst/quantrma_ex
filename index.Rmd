...
We have created an R project file for the labs that can be downloaded here: [download lab templates](https://github.com/thomashulst/quantrma_lab/raw/master/RMarkdownLabs.zip).
...
After downloading, you can double-click the R project file to make sure you are in the correct working directory to complete the labs. During the labs, you will write your notes and answers in a .Rmd (RMarkdown) file that can be downloaded at the beginning of the lab. At the end of each lab you will "knit" the file (knitting is a term for making your documents look prettier) and upload the result to Canvas.

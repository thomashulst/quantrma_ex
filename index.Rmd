...
We have created an R project file for the labs that can be [downloaded here](https://github.com/thomashulst/quantrma_lab/raw/master/Labs_Template.zip) or on Canvas.
...
2. Inside the folder you will see the "Labs.proj" project file and the template for the first lab
3. A data folder containing data files for the labs

You can double-click the R project file to make sure you are in the correct working directory to work on the labs. During the labs, you will write your notes and answers in a .Rmd (RMarkdown) file. At the end of each lab you will "knit" the file (knitting is a term for making your documents look prettier) and upload the result to Canvas.

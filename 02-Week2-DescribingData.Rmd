...
### First look at the data {#firstlook}
...
```{r 1subcategory, echo=TRUE,eval=TRUE,tidy=FALSE}
...
#### One country, life expectancy by year {#onecountry}
...
#### `sd()` = standard deviation {#returnsd}
...
### Descriptives by conditions {#descbycond}
...
#### `group_by()` and `summarise()` {#groupsumknit}

...
Try to understand what is happening in the code above. In both cases, we first load the library `tidyverse`. Then, we use the function `read_csv()` (from the `tidyverse`) to load the data and assign it to the variable `nyc_films`.

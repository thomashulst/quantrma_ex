...
```{r 1scatterC, echo=TRUE,eval=TRUE,warning=F}
...
```{r 1scatterD, echo=TRUE,eval=TRUE,warning=F}
ggplot(smaller_df,aes(y= lifeExp, x= year, 
...
2. Make a scatterplot of GDP per capita by year for the USA, Canada, and Mexico. Make sure to update the title and labels as well (hint: the USA is not named "USA" in the dataset).
3. Make a scatterplot of Life Expectancy by year for the five continents (hint: use the `group_by()` and `summarise()` functions).

...
1. Explain in your own words what is happening in the code block below. What does the `%>%` operator indicate? What about`n()`? 
```{r,eval=F,echo=T}
counts <- nyc_films %>% 
  group_by(Category) %>% 

...
A couple things now. First, the print out of this was ugly. We can fix that by putting the results of our code into a new variable, then use `knitr::kable()` to print it out nicely when we `knit` the document. We can even caption the table by passing the `caption` argument.

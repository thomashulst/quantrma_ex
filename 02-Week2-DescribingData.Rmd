...
For this lab, after completing the `ggplot()` exercises in your lab template, skip the additional materials in Section \@ref(addggplot) and go directly to Section \@ref(gaplab).

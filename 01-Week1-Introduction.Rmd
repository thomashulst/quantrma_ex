...
1. Download the template file for lab 1, [Lab01_Introduction.Rmd](https://raw.githubusercontent.com/thomashulst/quantrma_lab/master/Labs/Lab01_Introduction.Rmd) (right click: save as), and place it into the "Labs_Template" folder.
2. Double-click the "Labs.Rproj" file
3. RStudio should now start
4. If you click the files tab, you should some files and a data folder inside the "Labs_Template" folder
5. Click the lab template file (Lab01_Introduction.Rmd) and it will load into the editor window
6. You should keep your notes, copy/paste R code, and answer the questions of this lab in the lab RMarkdown document
...
When you have completed all exercises and are happy with your progress today, please knit your document (as a .docx) and submit it to Canvas. If you finish before the time is up, you can start with the required readings of Week 2 or help out your fellow students. 

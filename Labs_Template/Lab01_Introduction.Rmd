...
You can keep notes about the R part of the lab here and execute code like in a code block below:
...
Note: code blocks start with three back ticks followed by {r}. Code blocks end with another three back ticks. Anything within the code blocks is interpreted and executed as R-code. Statements outside code blocks are interpreted as text. 
